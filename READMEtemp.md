...
We successfully execute all the codes in both Windows (Win10) machines
...
You can create a new Python environment and instal2l required aforementioned packages (except for `arcpy`) via both the GUI or Command Line.
...
2. Unzip the full datasets (which can be provided upon request, see [Overview](https://github.com/tangjustinhaysechiwingg/EV-Public-Charging-Service-Text-Mining/blob/main/README.md#mapping-globally-public-charging-service-satisfaction-trajectories-of-electric-vehicle-users))
...
4. Outputs (including text files and figures) will be stored in the dir ``./dData/Interim`` and ``./Data/Figure_plots``, respectively.
