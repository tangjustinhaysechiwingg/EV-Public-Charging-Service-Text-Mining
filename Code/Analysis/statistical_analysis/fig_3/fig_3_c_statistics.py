...
def main():
    data_config = {
        'europe': {
            'comments': "Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\europe_comments.json",
            'regions': "Data\\input\\UID mapping\\Europe\\Ownership of Charging Station Area.json"
        },
        'usa': {
            'comments': "Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\usa_comments.json",
            'regions': "Data\\input\\UID mapping\\USA\\Ownership of Charging Station Area.json"
        },
        'china': {
            'comments': "Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\china_comments.json",
    ...
    output_dir = "Data\\Interim\\Fig3\\fig_3_c"
