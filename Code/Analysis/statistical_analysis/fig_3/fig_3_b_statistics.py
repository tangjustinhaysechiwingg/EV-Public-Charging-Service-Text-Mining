...
REGION_FILES = {
    'China': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\china_comments.json',
    'USA': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\usa_comments.json',
    'Europe': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\europe_comments.json'
}
...
def main():
    ...
    with open('Data\\Interim\\Fig3\\fig_3_b.json', 'w', encoding='utf-8') as f:
