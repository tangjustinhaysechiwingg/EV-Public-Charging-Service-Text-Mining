    ...
    'regions': {
        'China': {
            'input': {
                ...
                'comments_data': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\china_comments.json',
                'shapefile': 'Data\\input\\Boundary_data\\GADM\\china\\gadm41_CHN_1.shp'
            },
            'output': {
                'yearly_results_dir': "Data\\Interim\\Fig2\\fig_2_b\\china",
                'summary_tables_dir': "Data\\Interim\\Fig3\\fig_3_a\\china"
            }
        },
        'USA': {
            'input': {
                'region_mapping': 'Data\\input\\UID mapping\\USA\\Ownership of Charging Station Area.json',
                'comments_data': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\usa_comments.json',
                'shapefile': 'Data\\input\\Boundary_data\\GADM\\usa\\gadm41_USA_1.shp'
            },
            'output': {
                'yearly_results_dir': "Data\\Interim\\Fig2\\fig_2_b\\usa",
                'summary_tables_dir': "Data\\Interim\\Fig3\\fig_3_a\\usa"
            }
        },
        'Europe': {
            'input': {
                'region_mapping': 'Data\\input\\UID mapping\\Europe\\Ownership of Charging Station Area.json',
                'comments_data': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\europe_comments.json',
                'shapefile': 'Data\\input\\Boundary_data\\GADM\\europe\\Europe.shp'
            },
            'output': {
                'yearly_results_dir': "Data\\Interim\\Fig2\\fig_2_b\\europe",
                'summary_tables_dir': "Data\\Interim\\Fig3\\fig_3_a\\europe"
            }
        },
    },
    'analysis_dimensions': [
