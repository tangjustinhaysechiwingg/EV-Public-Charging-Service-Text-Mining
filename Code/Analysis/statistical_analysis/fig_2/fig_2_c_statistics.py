...
# Load all datasets
europe_data = load_data('Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\europe_comments.json')
usa_data = load_data('Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\usa_comments.json')
china_data = load_data('Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\china_comments.json')
...
with open('Data\\Interim\\Fig2\\fig_2_c.json', 'w', encoding='utf-8') as f:
