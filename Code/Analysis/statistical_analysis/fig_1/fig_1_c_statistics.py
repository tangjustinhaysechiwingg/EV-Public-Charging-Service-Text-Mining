...
if __name__ == "__main__":
    OUTPUT_DIR = 'Data\\Interim\\Fig1\\fig_1_c'
    
    # Process China data
    process_data(
        comments_path='Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\china_comments.json',
        mapping_path='Data\\input\\UID mapping\\China\\Ownership of Charging Station Area.json',
        shp_path='Data\\input\\Boundary_data\\GADM\\china\\gadm41_CHN_1.shp',
    ...
    # Process Europe data
    process_data(
        comments_path='Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\europe_comments.json',
    ...
    # Process USA data
    process_data(
        comments_path='Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\usa_comments.json',
        mapping_path='Data\\input\\UID mapping\\USA\\Ownership of Charging Station Area.json',
        shp_path='Data\\input\\Boundary_data\\GADM\\usa\\gadm41_USA_1.shp',
        output_dir=OUTPUT_DIR,
        region_field='HASC_1',
        region_name='usa'
    )
