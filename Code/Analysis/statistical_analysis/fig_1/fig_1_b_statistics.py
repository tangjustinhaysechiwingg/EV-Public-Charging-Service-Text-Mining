...
regions = {
    'China': {
        'filename': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\china_comments.json',
    ...
    'USA': {
        'filename': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\usa_comments.json',
        'date_format': "%Y-%m-%dT%H:%M:%SZ",  
        'timezone': timezones['USA']
    },
    'Europe': {
        'filename': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\europe_comments.json',
        'date_format': "%Y-%m-%dT%H:%M:%SZ",  
...
json_filename = "Data\\Interim\\Fig1\\fig_1_b.json"
