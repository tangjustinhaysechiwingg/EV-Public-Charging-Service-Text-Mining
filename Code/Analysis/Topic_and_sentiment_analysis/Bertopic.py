...
os.makedirs('Data\\Interim\\Topic_and_sentiment_analysis\\Bertopic', exist_ok=True)
nltk.data.path.append("Data\\Interim\\Topic_and_sentiment_analysis\\Bertopic")
...
json_files = [
    "Data\\Input\\Review_raw_data\\China_comments.json",
    "Data\\Input\\Review_raw_data\\USA_comments.json",
    "Data\\Input\\Review_raw_data\\Europe_comments.json"
]
...
output_path = 'Data\\Interim\\Topic_and_sentiment_analysis\\Bertopic'
