...
def main():
    #china
    review_file = "Data\\Input\\review_raw_data\\china_comments.json"
    output_file = "Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\china_comments.json" 
    processing(review_file,output_file)
    
    #usa
    review_file = "Data\\Input\\review_raw_data\\usa_comments.json" 
    output_file = "Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\usa_comments.json" 
    processing(review_file,output_file)
    
    #europe
    review_file = "Data\\Input\\review_raw_data\\europe_comments.json" 
    output_file = "Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result\\europe_comments.json" 
    processing(review_file,output_file)
