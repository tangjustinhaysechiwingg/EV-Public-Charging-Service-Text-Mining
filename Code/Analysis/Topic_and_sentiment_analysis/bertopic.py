...
os.makedirs('Data\\Interim\\opic and sentiment analysis\\Bertopic', exist_ok=True)
nltk.data.path.append("Data\\Interim\\opic and sentiment analysis\\Bertopic")
...
output_path = 'Data\\Interim\\opic and sentiment analysis\\Bertopic'
