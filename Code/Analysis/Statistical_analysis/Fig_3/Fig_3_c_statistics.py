...
def main():
    data_config = {
        'Europe': {
            'comments': "Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\Europe_comments.json",
            'regions': "Data\\input\\UID_mapping\\Europe\\Ownership_of_charging_station_area.json"
        },
        'USA': {
            'comments': "Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\USA_comments.json",
            'regions': "Data\\input\\UID_mapping\\USA\\Ownership_of_charging_station_area.json"
        },
        'China': {
            'comments': "Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\China_comments.json",
            'regions': "Data\\input\\UID_mapping\\China\\Ownership_of_charging_station_area.json"
        }
    }
    ...
    output_dir = "Data\\Interim\\Fig_3\\Fig_3_c"
