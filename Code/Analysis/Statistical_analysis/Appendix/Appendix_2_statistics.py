...
def process_occupied_hourly(data):
    ...
    with open('Data\\Interim\\Appendix_2\\Hourly_occupied_comment_ratio.json', 'w', encoding='utf-8') as f:
...
def process_occupied_weekly(data):
    ...
    with open('Data\\Interim\\Appendix_2\\Weekly_occupied_comment_ratio.json', 'w', encoding='utf-8') as f:
...
def process_broken_monthly(data):
    ...
    with open('Data\\Interim\\Appendix_2\\Monthly_broken_comment_ratio.json', 'w', encoding='utf-8') as f:
        json.dump(monthly_comment_ratio, f, ensure_ascii=False, indent=2)

def main():

    with open('Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\China_comments.json', 'r', encoding='utf-8') as f:
        data = json.load(f)
