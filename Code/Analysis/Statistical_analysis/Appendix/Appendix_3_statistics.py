...
# Region files
region_files = {
    'China': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\China_comments.json',
    'USA': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\USA_comments.json',
    'Europe': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\Europe_comments.json'
}
# Themes
themes = [
...
os.makedirs('Data\\Interim\\Appendix_3', exist_ok=True)
with open('Data\\Interim\\Appendix_3\\Wordcloud_keywords.json', 'w', encoding='utf-8') as f:
