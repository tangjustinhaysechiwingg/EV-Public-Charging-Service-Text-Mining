    ...
    def calculate_gini_coefficients(self):
        ...
        for category in self.EVALUATION_CATEGORIES:
            ...
            with rasterio.open(tiff_path) as charger_src, \
                ...
                category1 = f"{category.split(" ")[0]}_{category.split(" ")[1]}"
                output_csv_path = os.path.join(output_folder, f"{category1}_gini_results.csv")
                result_df.to_csv(output_csv_path, index=False, encoding='utf-8-sig')
                print(f"Saved Gini results for {category1} to {output_csv_path}")
...
if __name__ == "__main__":
    ...
    input_json_path = "Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\Europe_comments.json"
    output_base_folder = "Data\\Interim\\Fig_4\\Positive_station\\Europe"
    population_tiff_path = "Data\\Input\\Worldpop\\Europe.tif"
    region_shapefile = "Data\\Input\\Boundary_data\\GADM\\Europe\\Europe.shp"
    ...
    input_json_path = "Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\China_comments.json"
    output_base_folder = "Data\\Interim\\Fig_4\\Positive_station\\China"
    population_tiff_path = "Data\\Input\\Worldpop\\China.tif"
    region_shapefile = "Data\\Input\\Boundary_data\\GADM\\China\\China.shp"
    ...
    input_json_path = "Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\USA_comments.json"
    output_base_folder = "Data\\Interim\\Fig_4\\Positive_station\\USA"
    population_tiff_path = "Data\\Input\\Worldpop\\USA.tif"
    region_shapefile = "Data\\Input\\Boundary_data\\GADM\\USA\\USA.shp"
