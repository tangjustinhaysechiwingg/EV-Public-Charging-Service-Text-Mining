...
# Load all datasets
europe_data = load_data('Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\Europe_comments.json')
usa_data = load_data('Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\USA_comments.json')
china_data = load_data('Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\China_comments.json')
...
with open('Data\\Interim\\Fig_2\\Fig_2_c.json', 'w', encoding='utf-8') as f:
