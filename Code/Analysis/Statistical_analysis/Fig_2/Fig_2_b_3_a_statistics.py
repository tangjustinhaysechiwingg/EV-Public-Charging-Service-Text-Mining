...
GLOBAL_CONFIG = {
    'regions': {
        'China': {
            'input': {
                'region_mapping': 'Data\\input\\UID_mapping\\China\\Ownership_of_charging_station_area.json',
                'comments_data': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\China_comments.json',
                'shapefile': 'Data\\input\\Boundary_data\\GADM\\China\\China.shp'
            },
            'output': {
                'yearly_results_dir': "Data\\Interim\\Fig_2\\Fig_2_b\\China",
                'summary_tables_dir': "Data\\Interim\\Fig_3\\Fig_3_a\\China"
            }
        },
        'USA': {
            'input': {
                'region_mapping': 'Data\\input\\UID_mapping\\USA\\Ownership_of_charging_station_area.json',
                'comments_data': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\USA_comments.json',
                'shapefile': 'Data\\input\\Boundary_data\\GADM\\USA\\USA.shp'
            },
            'output': {
                'yearly_results_dir': "Data\\Interim\\Fig_2\\Fig_2_b\\USA",
                'summary_tables_dir': "Data\\Interim\\Fig_3\\Fig_3_a\\USA"
            }
        },
        'Europe': {
            'input': {
                'region_mapping': 'Data\\input\\UID_mapping\\Europe\\Ownership_of_charging_station_area.json',
                'comments_data': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\Europe_comments.json',
                'shapefile': 'Data\\input\\Boundary_data\\GADM\\Europe\\Europe.shp'
            },
            'output': {
                'yearly_results_dir': "Data\\Interim\\Fig_2\\Fig_2_b\\Europe",
                'summary_tables_dir': "Data\\Interim\\Fig_3\\Fig_3_a\\Europe"
            }
        },
    },
    'analysis_dimensions': [
