...
if __name__ == "__main__":
    OUTPUT_DIR = 'Data\\Interim\\Fig_1\\Fig_1_c'
    
    # Process China data
    process_data(
        comments_path='Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\China_comments.json',
        mapping_path='Data\\input\\UID_mapping\\China\\Ownership_of_charging_station_area.json',
        shp_path='Data\\input\\Boundary_data\\GADM\\China\\China.shp',
    ...
    # Process Europe data
    process_data(
        comments_path='Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\Europe_comments.json',
        mapping_path='Data\\Input\\UID_mapping\\Ownership_of_charging_station_area.json',
        shp_path='Data\\input\\Boundary_data\\GADM\\Europe\\Europe.shp',
        output_dir=OUTPUT_DIR,
        region_field='HASC_1',
        region_name='Europe'
    )
    ...
    # Process USA data
    process_data(
        comments_path='Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\USA_comments.json',
        mapping_path='Data\\input\\UID_mapping\\USA\\Ownership_of_charging_station_area.json',
        shp_path='Data\\input\\Boundary_data\\GADM\\USA\\USA.shp',
        output_dir=OUTPUT_DIR,
        region_field='HASC_1',
        region_name='USA'
    )
