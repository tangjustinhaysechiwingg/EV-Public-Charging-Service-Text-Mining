...
regions = {
    'China': {
        'filename': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\China_comments.json',
    ...
    'USA': {
        'filename': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\USA_comments.json',
        'date_format': "%Y-%m-%dT%H:%M:%SZ",  
        'timezone': timezones['USA']
    },
    'Europe': {
        'filename': 'Data\\Interim\\Topic_and_sentiment_analysis\\LLM_result_processing\\Europe_comments.json',
        'date_format': "%Y-%m-%dT%H:%M:%SZ",  
...
json_filename = "Data\\Interim\\Fig_1\\Fig_1_b.json"
